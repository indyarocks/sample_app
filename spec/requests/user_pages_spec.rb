  ...
  describe "profile page" do
    ...
    describe "follow/unfollow buttons" do
      ...
      describe "following a user" do
        ...
        it "should increase user's followed user count by 1" do
          expect do
            click_button 'Follow'
          end.to change(user.followed_users, :count).by(+1)
        end

        it "should increase the other user's followers count by 1" do
          expect do
            click_button 'Follow'
      ...
      describe "unfollowing a user" do
        ...
        it "should decrease user's followed user count by 1" do
          expect do
            click_button 'Unfollow'
          end.to change(user.followed_users, :count).by(-1)
        end

        it "should decrease other user's followers count by 1" do
          expect do
            click_button 'Unfollow'
          end.to change(other_user.followers, :count).by(-1)
        end
